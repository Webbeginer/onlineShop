...
const ModalLayout = ({children}: {children: React.ReactNode}) => {
    ...
    return(
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border border-gray-200 rounded-md bg-transparent backdrop-blur-md md:w-[400px] md:h-[550px]">{children}</div>
        </div>
        </>
    )
}
